...
const productNameChain = body("product_name").isString().isLength({ min: 3, max: 50 });
...
const priceMeasurementChain = body("price_measurement").isInt({min: 0, max: 1});
...
const applyUpdateProductRules = [imageChain, productNameChain, priceChain, priceMeasurementChain];
